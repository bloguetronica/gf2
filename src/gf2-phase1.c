/* GF2 Phase1 Command - Version 1.1 for Debian Linux
        ...
        else  // If libusb is initialized
        {
            ...
            else  // If the device is successfully opened and a handle obtained
            {
                ...
                else  // If the interface is successfully claimed
                {
                    ...
                    set_phase(devhandle, phase_code, PHASE1);  // Set the PHASE1 register to the intended value (by sending a sequence of bytes to the AD9834 waveform generator on channel 0)
