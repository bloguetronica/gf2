/* GF2 Phase1 Command - Version 1.0 for Debian Linux
...
void set_phase1(libusb_device_handle *devhandle, unsigned short value);
        ...
        else  // If libusb is initialized
        {
            ...
            else  // If the device is successfully opened and a handle obtained
            {
                ...
                else  // If the interface is successfully claimed
                {
                    ...
                    set_phase1(devhandle, phase_code);  // Set the PHASE1 register to the intended value (by sending a sequence of bytes to the AD9834 waveform generator on channel 0)
...
void set_phase1(libusb_device_handle *devhandle, unsigned short value)  // Sets the PHASE1 register on the AD9834 waveform generator to a given value
{
    unsigned char write_command_buf[10] = {
        ...
        0xE0 + (0x0F & (unsigned char)(value >> 8)),  // PHASE1 register set to the given value
        (unsigned char)value
    };
    int bytes_written;
