/* GF2 Freq1 Command - Version 1.1 for Debian Linux
            ...
            else  // If libusb is initialized
            {
                ...
                else  // If the device is successfully opened and a handle obtained
                {
                    ...
                    else  // If the interface is successfully claimed
                    {
                        ...
                        set_frequency(devhandle, freq_code, FREQ1);  // Set the FREQ1 register to the intended value (by sending a sequence of bytes to the AD9834 waveform generator on channel 0)
