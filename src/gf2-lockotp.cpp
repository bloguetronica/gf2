/* GF2 LockOTP Command - Version 2.0 for Debian Linux
...
int main(int argc, char **argv)
{
    ...
    if (argc < 2) {  // If the program was called without arguments
        ...
        CP2130 cp2130;
        int err = cp2130.open(GF2Device::VID, GF2Device::PID, argv[1]);
        if (err == GF2Device::SUCCESS) {  // Open the device having the specified serial number, and get the device handle. If successful
            int errcnt = 0;
            std::string errstr;
